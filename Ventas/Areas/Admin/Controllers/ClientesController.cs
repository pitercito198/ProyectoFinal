...
namespace Ventas.Areas.Admin.Controllers
{
    ...
    public class ClientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ClienteId,CI,Nombre,Apellido,Email,Telefono,Direccion")] Cliente cliente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ClienteId,CI,Nombre,Apellido,Email,Telefono,Direccion")] Cliente cliente)
        {
